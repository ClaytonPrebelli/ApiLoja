...
namespace ApiLoja.Repositories
{
    public class CandidatosRepository : ICandidatosRepository
    {
        ...
        public byte[] MontarFicha(CandidatosModels candidato, int idade)
        {
            ...
            html.Append("  </div></div>");
            html.Append("<style>");
            html.Append("*{margin:0;padding:0;box-sizing:border-box;}html{border:0;padding:0;}body{border:0;padding:0;display:flex;}.ficha{width:100%;border:0;padding: 0;background-image:url(https://restrito.glumbsp.com.br/assets/images/bg_blue.jpg);background-size: cover;}.ficha--inner{border:1px solid #343e99;  width:100%;   height: 100%;   background-color: #fff;        padding: 0; }");
            html.Append(".ficha--inner--head{background-image: url(https://restrito.glumbsp.com.br/assets/images/head-fichaCandidato.png);    width:100%;            height: 3cm;            background-size: 100% 100%;}");
