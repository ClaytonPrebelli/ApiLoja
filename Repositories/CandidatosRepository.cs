...
namespace ApiLoja.Repositories
{
    public class CandidatosRepository : ICandidatosRepository
    {
        ...
        public byte[] MontarFicha(CandidatosModels candidato, int idade)
        {
            ...
            html.Append(".nome{    width: 65%;            font-size: 15pt;        }.cim{    width:29%;     font-size: 15pt;}.sangue{    color:#aa0000;    font-weight: 600;}.loja{    font-size: 15pt;}.cargo{width: 48%;}.datas{width: 33%;}");
