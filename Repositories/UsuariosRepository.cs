...
namespace ApiLoja.Repositories
{
    public class UsuariosRepository : IUsuariosRepository
    {
        ...
        public byte[] GerarCarteirinha(UsuarioModels macom,LojaModels loja)
        {
            var html = new StringBuilder();
            html.Append(" <div class='box-carteirinha'>     <div class='carteirinha--frente'>");
            html.Append($"<img src='https://restrito.glumbsp.com.br/assets/images/logos/glumbsp_logo.png' alt='' class='carteirinha--frente--glumb'>           <div lass='carteirinha--frente--head'>                                <div class='carteirinha--frente--head--cim'>                                    <h4 class='carteirinha--frente--head--cim--title'>CARTEIRA DE IDENTIDADE MAÇÔNICA</h4>                                    <h4 class='carteirinha--frente--head--cim--numero'>{macom.CIM.ToString().PadLeft(6,'0')}</h4></div><div class='carteirinha--frente--head--nome'><h4 class='carteirinha--frente--head--nome--title'>{ macom.Nome.ToString() }</h4><h4 class='carteirinha--frente--head--nome--grau'>{ConverteGrau(macom)}</h4></div></div>");
            ...
            html.Append("  </div>  <div class='carteirinha--tras--ass'> <img src = 'https://restrito.glumbsp.com.br/assets/images/ser.png' alt='' class='carteirinha--tras--ass--img'>                            </div>                        </div></div>");
            ...
            html.Append(" .carteirinha--frente{        width: 8.5cm;        height: 5.5cm;            border-radius: 16px;        border: 2px solid black;            background-image: url('https://restrito.glumbsp.com.br/assets/images/bg-frente.png');            background-size: cover;        padding: 0.2cm 0.2cm;        overflow: hidden;        display: flex;            justify-content: space-between;            align-items: space-between;            row-gap: 10px;            flex-wrap: wrap;        }        .carteirinha--frente--glumb{            width:1.5cm;            height: 1.7cm;        }");
            ...
            html.Append(".carteirinha--tras{        width: 8.5cm;        height: 5.5cm;            border-radius: 16px;        border: 2px solid black;            background-image: url('https://restrito.glumbsp.com.br/assets/images/bg-tras.png');            background-size: cover;        padding: 0.5cm 0.2cm;        overflow: hidden;        display: flex;            justify-content: space-between;            align-items: space-between;            row-gap: 10px;            flex-wrap: wrap;  }");
